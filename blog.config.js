...
const BLOG = {
  ...
  AUTHOR: process.env.NEXT_PUBLIC_AUTHOR || '伍六七', // 您的昵称 例如 tangly1024
  BIO: process.env.NEXT_PUBLIC_BIO || '以梦为马，诗酒趁年华', // 作者简介
  LINK: process.env.NEXT_PUBLIC_LINK || 'https://blog.gray.ccwu.cc/', // 网站地址
  KEYWORDS: process.env.NEXT_PUBLIC_KEYWORD || 'Notion, 博客,技术小白,互联网工具爱好者，实用主义者', // 网站关键词 英文逗号隔开
  BLOG_FAVICON: process.env.NEXT_PUBLIC_FAVICON || '/favicon.ico', // blog favicon 配置, 默认使用 /public/favicon.ico，支持在线图片，如 https://img.imesong.com/favicon.png
  BEI_AN: process.env.NEXT_PUBLIC_BEI_AN || '萌ICP备20260567号', // 备案号 闽ICP备XXXXXX
  BEI_AN_LINK: process.env.NEXT_PUBLIC_BEI_AN_LINK || 'https://icp.gov.moe/?keyword=20260567,target="_blank" style="color: pink;', // 备案查询链接，如果用了萌备等备案请在这里填写
